...
from networksecurity.utils.ml_utils.metric.classificatin_metric import get_classification_score
from networksecurity.utils.ml_utils.model.estimator import NetworModel
...
dagshub.init(repo_owner='renjini2539thomas', repo_name='NetworkSecurity', mlflow=True)
...
class ModelTrainer:
    ...
    def track_mlflow(self, best_model, train_metric, test_metric):
        """
        Logs metrics and model to MLflow (DagsHub compatible).
        """
        with mlflow.start_run():
            ...
            local_model_path = "saved_models/best_model"
    ...
    def train_model(self, x_train, y_train, x_test, y_test):
        ...
        Network_Model = NetworModel(preprocessor=preprocessor, model=best_model)
